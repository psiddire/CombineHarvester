...
int main(int argc, char* argv[]){
 ...
 string folder="$CMSSW_BASE/src/CombineHarvester/CombineTools/shapes_em_BDT";
 ...
 for (int i = 0; i < 5; i++)
   {
     ...
     TFile input((folder + "/" + inputFile).c_str(), "READONLY");
 ...
 const Int_t ny = 5;
 string channels[ny] = {"H#rightarrow e#tau_{#mu}", "e#tau_{#mu}, VBF","e#tau_{#mu}, 2 Jets","e#tau_{#mu}, 1 Jet", "e#tau_{#mu}, 0 Jets"};
 ...
 string inputFile = folder + "/SUMMARY.pdf";
