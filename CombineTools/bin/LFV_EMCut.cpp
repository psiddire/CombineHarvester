...
int main(int argc, char* argv[]){
  ...
  // Trigger
  cb.cp().process(ch::JoinStr({sig_procs, mc_procs}))
    .AddSyst(cb, "CMS_eff_trigger_etaumu_2016", "lnN", SystMap<>::init(1.02));
  cb.cp().process({"ZTauTau"})
    .AddSyst(cb, "CMS_eff_trigger_emb_etaumu_2016", "lnN", SystMap<>::init(1.02));
  cb.cp().process({"ZTauTau"})
  ...
  AddShapes({"CMS_qcd_0jet_rate_2016", "CMS_qcd_1jet_rate_2016", "CMS_qcd_2jet_rate_2016", "CMS_qcd_0jet_shape_2016", "CMS_qcd_1jet_shape_2016", "CMS_qcd_2jet_shape_2016", "CMS_qcd_extrapolation"}, {"QCD"}, &cb, TheFile, {"0jet", "1jet", "2jet_gg", "2jet_vbf"});
