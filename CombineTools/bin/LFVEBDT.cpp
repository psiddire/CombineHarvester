...
int main(int argc, char* argv[]){
 ...
 string label = "h#rightarrow e#tau BDT fit";
 string lumi = "137";
 ...
 string appendix[9] = {"et1", "et2", "et3", "et4", "em1", "em2", "em3", "em4", "Comb"};
 ...
 const Int_t ny = 9;
 string channels[ny] = {"e#tau", "e#tau_{#mu}, VBF","e#tau_{#mu}, 2 Jets","e#tau_{#mu}, 1 Jet", "e#tau_{#mu}, 0 Jets", "e#tau_{h}, VBF","e#tau_{h}, 2 Jets","e#tau_{h}, 1 Jet", "e#tau_{h}, 0 Jets"};
 ...
 h->SetXTitle("95% CL limit on #bf{#it{#Beta}}(H#rightarrow e#tau) %");
 ...
 GRAPHMEDIAN->SetLineColor(kBlue+2); GRAPHMEDIAN->SetMarkerStyle(5); GRAPHMEDIAN->SetMarkerColor(kBlue+2); GRAPHMEDIAN->SetMarkerSize(1.0); GRAPHMEDIAN->SetLineWidth(1);
