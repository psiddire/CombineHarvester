...
int main(int argc, char* argv[]){
  ...
  string outputFile="HETau_etauhad_2018_m125.input";
  string dirInput="";
  bool binbybin=false;
  string name="def";
  ...
  cb.AddObservations({"*"}, {"HETau"}, {"2018"}, {"etauhad"}, cats);

  vector<string> bkg_procs = {"ggH_htt", "qqH_htt", "ggH_hww", "qqH_hww", "Zothers", "EWK", "TT", "T", "Diboson", "Fakes", "ZTauTau"};
  cb.AddProcesses({"*"}, {"HETau"}, {"2018"}, {"etauhad"}, bkg_procs, cats, false);

  vector<string> sig_procs = {"LFVGG", "LFVVBF"};
  cb.AddProcesses(masses, {"HETau"}, {"2018"}, {"etauhad"}, sig_procs, cats, true);
  ...
  // Trigger
  cb.cp().process(ch::JoinStr({sig_procs, mc_procs}))
    .AddSyst(cb, "CMS_Trigger_etauh_2018_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"ZTauTau"})
    .AddSyst(cb, "CMS_Trigger_emb_etauh_2018_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"ZTauTau"})
  ...
  cb.cp().process({"Fakes"})
    .AddSyst(cb, "CMS_eFR_p0_2018_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"Fakes"})
    .AddSyst(cb, "CMS_eFR_p1_2018_13TeV", "shape", SystMap<>::init(1.0));
