...
int main(int argc, char* argv[]){
  ...
  // Trigger
  cb.cp().process(ch::JoinStr({sig_procs, mc_procs}))
    .AddSyst(cb, "CMS_Trigger_etaumu_2017_13TeV", "lnN", SystMap<>::init(1.02));
  cb.cp().process({"ZTauTau"})
    .AddSyst(cb, "CMS_Trigger_emb_etaumu_2017_13TeV", "lnN", SystMap<>::init(1.02));
  cb.cp().process({"ZTauTau"})
  ...
  cb.cp().process({"QCD"})
    .AddSyst(cb, "CMS_QCD_0JetRate_2017_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"QCD"})
    .AddSyst(cb, "CMS_QCD_1JetRate_2017_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"QCD"})
    .AddSyst(cb, "CMS_QCD_2JetRate_2017_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"QCD"})
    .AddSyst(cb, "CMS_QCD_0JetShape_2017_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"QCD"})
    .AddSyst(cb, "CMS_QCD_1JetShape_2017_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"QCD"})
    .AddSyst(cb, "CMS_QCD_2JetShape_2017_13TeV", "shape", SystMap<>::init(1.0));
  cb.cp().process({"QCD"})
